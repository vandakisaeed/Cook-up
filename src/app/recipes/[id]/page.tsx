...
import { prisma } from "@/lib/prisma";
import { Recipe } from "@/types";
import { notFound } from "next/navigation"; // ✅ use this instead of your NotFound component
...
export default async function RecipeDetailPage({ params }: RecipePageProps) {
  ...
  try {
    ...
    throw err; // ✅ will be caught by app/error.tsx
  }

  if (!recipe) {
    return notFound(); // ✅ show 404 page instead of crashing
  }
